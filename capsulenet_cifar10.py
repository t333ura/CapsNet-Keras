...
def CapsNet(input_shape, n_class, routings):
    ...
    primarycaps = PrimaryCap(conv1, dim_capsule=8, n_channels=64, kernel_size=9, strides=2, padding='valid') # 64 types of PriCaps for CIFAR10

    # Layer 3: Capsule layer. Routing algorithm works here.
    # 'none-of-the-above' category for CIFAR10 
...
if __name__ == "__main__":
    ...
    parser.add_argument('--lam_recon', default=0.864, type=float,
                        help="The coefficient for the loss of decoder") # 0.0005*24*24*3 for CIFAR10
